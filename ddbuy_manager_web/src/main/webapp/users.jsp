...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#dg").datagrid({
                ...
                columns:[[
                    ...
                    {field:'isadmin',title:'状态',width:100,align:"center"},
                    {field:'opt',title:'操作',width:100,align:"center",
                        formatter: function(value,row,index){  // 字段的值，此行数据，行索引
                            // return "<a href='delType?id="+row.id+"'>删除</a>";
                            return "<a href='javascript:delSingle("+row.id+row.isadmin+")'>删除</a>";
                        }
                    }
                ]]
            })
        ...
        function searchUser() {
            ...
            var endAge=$("#end").val();
            $('#dg').datagrid('load', {"name":name,"telephone":tel,"startAge":startAge,"endAge":endAge});
        }
    </script>
</head>
