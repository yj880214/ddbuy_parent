    	...
    	<div class="banner">    	
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    <c:forEach items="${contentList}" var="l">
                        <li><img src="${l.pic}" width="740" height="401" id="urlId" />
                        </li>
                    </c:forEach>
...
<div class="top">
    ...
    <div class="search">
        <form action="http://localhost:8085/search" method="post">
            <input type="text" name="condition" class="s_ipt">
            <input type="submit" value="搜索" class="s_btn">
        </form>
        <span class="fl">
